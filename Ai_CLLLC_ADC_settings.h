...
#define CLC_VPRIM_MAX_SENSE_VOLTS           ((float32_t)166)    // Vreal*10/(330K*5+10K)=VADC, 6.024mV/V
#define CLC_VSEC_MAX_SENSE_VOLTS            ((float32_t)31.06)  // Vreal*4.99/(4.99K+75K*2)=VADC, 31.06mV/V
#define CLC_ISEC_MAX_SENSE_AMPS             ((float32_t)50)
#define CLC_IPRIM_TANK_MAX_SENSE_AMPS       ((float32_t)33.333)

#define CLC_VSEC_NOMINAL_VOLTS              ((float32_t)24)
#define CLC_VPRIM_NOMINAL_VOLTS             ((float32_t)155)

#define CLC_ISEC_TRIP_LIMIT_AMPS            ((float32_t)41.6)
#define CLC_IPRIM_TANK_TRIP_LIMIT_AMPS      ((float32_t)27.8)
#define CLC_VPRIM_TRIP_LIMIT_VOLT           ((float32_t)132.8)
#define CLC_VSEC_TRIP_LIMIT_VOLT            ((float32_t)24.848)
...
#define CLC_VPRIM_ADC_ACQPS_SYS_CLKS 59
...
#define CLC_VPRIM_OV_SAMPLE_ADC ((CLC_VPRIM_ADCREAD_0 + CLC_VPRIM_ADCREAD_1 + CLC_VPRIM_ADCREAD_2 + CLC_VPRIM_ADCREAD_3) * 0.25)
...
#define CLC_IPRIM_TANK_ADC_ACQPS_SYS_CLKS  59
...
#define CLC_IPRIM_TANK_OV_SAMPLE_ADC ((CLC_IPRIM_TANK_ADCREAD_4 + CLC_IPRIM_TANK_ADCREAD_5 + CLC_IPRIM_TANK_ADCREAD_6 + CLC_IPRIM_TANK_ADCREAD_7) * 0.25)
...
#define CLC_VSEC_ADC_ACQPS_SYS_CLKS 59
#define CLC_VSEC_ADCRESULTREGBASE ADCCRESULT_BASE

#define CLC_VSEC_ADC_SOC_NO_4  ADC_SOC_NUMBER4
#define CLC_VSEC_ADC_SOC_NO_5  ADC_SOC_NUMBER5
#define CLC_VSEC_ADC_SOC_NO_6  ADC_SOC_NUMBER6  // Vsec output 0 ~ 850V
#define CLC_VSEC_ADC_SOC_NO_7  ADC_SOC_NUMBER7

#define CLC_VSEC_ADCREAD_4 ADC_readResult(CLC_VSEC_ADCRESULTREGBASE, CLC_VSEC_ADC_SOC_NO_4)
#define CLC_VSEC_ADCREAD_5 ADC_readResult(CLC_VSEC_ADCRESULTREGBASE, CLC_VSEC_ADC_SOC_NO_5)
#define CLC_VSEC_ADCREAD_6 ADC_readResult(CLC_VSEC_ADCRESULTREGBASE, CLC_VSEC_ADC_SOC_NO_6)
#define CLC_VSEC_ADCREAD_7 ADC_readResult(CLC_VSEC_ADCRESULTREGBASE, CLC_VSEC_ADC_SOC_NO_7)

#define CLC_VSEC_ADCREAD (CLC_VSEC_ADCREAD_4)
#define CLC_VSEC_OV_SAMPLE_ADC ((CLC_VSEC_ADCREAD_4 + CLC_VSEC_ADCREAD_5 + CLC_VSEC_ADCREAD_6 + CLC_VSEC_ADCREAD_7) * (0.25F))
...
#define CLC_ISEC_ADC_ACQPS_SYS_CLKS 59
#define CLC_ISEC_ADCRESULTREGBASE ADCCRESULT_BASE

#define CLC_ISEC_ADC_SOC_NO_0  ADC_SOC_NUMBER0
#define CLC_ISEC_ADC_SOC_NO_1  ADC_SOC_NUMBER1
#define CLC_ISEC_ADC_SOC_NO_2  ADC_SOC_NUMBER2
#define CLC_ISEC_ADC_SOC_NO_3  ADC_SOC_NUMBER3

#define CLC_ISEC_ADCREAD_0 ADC_readResult(CLC_ISEC_ADCRESULTREGBASE, CLC_ISEC_ADC_SOC_NO_0)
#define CLC_ISEC_ADCREAD_1 ADC_readResult(CLC_ISEC_ADCRESULTREGBASE, CLC_ISEC_ADC_SOC_NO_1)
#define CLC_ISEC_ADCREAD_2 ADC_readResult(CLC_ISEC_ADCRESULTREGBASE, CLC_ISEC_ADC_SOC_NO_2)
#define CLC_ISEC_ADCREAD_3 ADC_readResult(CLC_ISEC_ADCRESULTREGBASE, CLC_ISEC_ADC_SOC_NO_3)

#define CLC_ISEC_ADCREAD (CLC_ISEC_ADCREAD_0)
#define CLC_ISEC_OV_SAMPLE_ADC ((CLC_ISEC_ADCREAD_0 + CLC_ISEC_ADCREAD_1 + CLC_ISEC_ADCREAD_2 + CLC_ISEC_ADCREAD_3) * (0.25F))
